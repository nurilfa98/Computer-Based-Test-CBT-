            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Ubah Ujian</h3>
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form action="<?= base_url() ?>c_ujian/ubhujian" method="post">
                            ...
                            <div class="col-md-8">
                                <?php foreach ($dataUjian as $ujian) : ?>
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="nama_ujian" id="ujian" value="<?= $ujian['nama_ujian'] ?>" class="form-control" placeholder="Tulis Nama Ujian.." onfocus="this.selectionStart = this.selectionEnd = this.value.length;" required autofocus autocomplete="off">
                                    </div>
                                    <div class="form-group">
                                        <label>Kelas</label>
                                        <select name="kelas" class="form-control" style="width: 100%;" required autocomplete="off">
                                            ...
                                            <?php foreach ($getKelas as $k) : ?>
                                                <?php if ($ujian['kelas_id'] == $k['kelas_id']) : ?>
                                                    <option selected value="<?= $k['id_kelas'] ?>|<?= $k['id_jurusan'] ?>"><?= $k['nama_kelas'] . ' ' . $k['nama_jurusan'] ?></option>
                                                <?php else : ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="waktu" value="<?= $ujian['waktu'] ?>" class="form-control" id="waktu" placeholder="Berapa Menit.." required required autocomplete="off">
                                    </div>
